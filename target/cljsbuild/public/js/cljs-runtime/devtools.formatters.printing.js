...
var len__4736__auto___52268 = arguments.length;
var i__4737__auto___52269 = (0);
while(true){
if((i__4737__auto___52269 < len__4736__auto___52268)){
args__4742__auto__.push((arguments[i__4737__auto___52269]));

var G__52270 = (i__4737__auto___52269 + (1));
i__4737__auto___52269 = G__52270;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq52200){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52201,G__52202,seq52200__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__52207_SHARP_){
return (!((cljs.core.meta(p1__52207_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52215__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e52219){var _e__51492__auto__ = e52219;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e52221){var _e__51492__auto__ = e52221;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__52225 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__52226 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__52226);

try{var map__52227 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52227__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__52225);
}});
...
var temp__5733__auto___52307 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___52307)){
var managed_print_level_52309 = temp__5733__auto___52307;
var _STAR_print_level_STAR__orig_val__52254_52310 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__52255_52311 = managed_print_level_52309;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__52255_52311);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__52253_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__52253_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__52254_52310);
}} else {
job_fn();
}
