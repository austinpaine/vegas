...
var len__4736__auto___65529 = arguments.length;
var i__4737__auto___65533 = (0);
while(true){
if((i__4737__auto___65533 < len__4736__auto___65529)){
args__4742__auto__.push((arguments[i__4737__auto___65533]));

var G__65534 = (i__4737__auto___65533 + (1));
i__4737__auto___65533 = G__65534;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown.common.freeze_string.cljs$lang$applyTo = (function (seq65479){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq65479));
}));
...
var G__65540 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5733__auto__){
return (function (s,r){
return clojure.string.replace(s,cljs.core.re_pattern(r),((function (text,state,matches,temp__5733__auto__){
return (function (p1__65482_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__65482_SHARP_,p1__65482_SHARP_);
});})(text,state,matches,temp__5733__auto__))
);
});})(text,state,matches,temp__5733__auto__))
,text,matches);
var G__65541 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5733__auto__){
return (function (p1__65483_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__65483_SHARP_,matches);
});})(text,state,matches,temp__5733__auto__))
);
text = G__65540;
state = G__65541;
...
var vec__65505 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__65508 = (function (){var G__65511 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__65512 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__65511,G__65512) : transformer.call(null,G__65511,G__65512));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65508,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65508,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65505,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65505,(1),null);
var G__65594 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__65596 = cljs.core.PersistentVector.EMPTY;
var G__65597 = cljs.core.rest(tokens);
var G__65598 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__65594;
buf = G__65596;
tokens = G__65597;
cur_state = G__65598;
...
var G__65607 = out;
var G__65608 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__65609 = cljs.core.rest(tokens);
var G__65610 = cur_state;
out = G__65607;
buf = G__65608;
tokens = G__65609;
cur_state = G__65610;
...
var G__65623 = out;
var G__65624 = buf;
var G__65625 = cljs.core.rest(tokens);
var G__65626 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__65623;
buf = G__65624;
tokens = G__65625;
cur_state = G__65626;
...
var G__65627 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__65628 = buf;
var G__65629 = cljs.core.rest(tokens);
var G__65630 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911),markdown.common.open_html_tags(new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911).cljs$core$IFn$_invoke$arity$1(cur_state),cljs.core.first(tokens)));
out = G__65627;
buf = G__65628;
tokens = G__65629;
cur_state = G__65630;
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__65517_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__65517_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__65518_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__65518_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__65518_SHARP_)));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
