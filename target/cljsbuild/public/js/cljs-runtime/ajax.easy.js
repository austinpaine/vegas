...
var G__65410 = format;
var G__65410__$1 = (((G__65410 instanceof cljs.core.Keyword))?G__65410.fqn:null);
switch (G__65410__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__65411 = cljs.core.second(format);
var G__65412 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__65411,G__65412) : ajax.easy.keyword_response_format_element.call(null,G__65411,G__65412));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__65413 = format;
var G__65413__$1 = (((G__65413 instanceof cljs.core.Keyword))?G__65413.fqn:null);
switch (G__65413__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65414_SHARP_){
return ajax.easy.keyword_response_format_element(p1__65414_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__65419){
var map__65420 = p__65419;
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65420__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65420__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65420__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__65429){
var vec__65430 = p__65429;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65430,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65430,(1),null);
var fexpr__65436_65449 = (cljs.core.truth_(ok)?h:e);
(fexpr__65436_65449.cljs$core$IFn$_invoke$arity$1 ? fexpr__65436_65449.cljs$core$IFn$_invoke$arity$1(result) : fexpr__65436_65449.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__65440){
...
var opts = map__65441__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65441__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65441__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65441__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65441__$1,new cljs.core.Keyword(null,"params","params",710516235));
