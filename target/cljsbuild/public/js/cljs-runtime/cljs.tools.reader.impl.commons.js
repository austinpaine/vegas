...
var G__60300 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__60300;
continue;
} else {
return ch;
...
var vec__60267 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60267,(0),null);
return (match === s);
});
...
var len__4736__auto___60328 = arguments.length;
var i__4737__auto___60329 = (0);
while(true){
if((i__4737__auto___60329 < len__4736__auto___60328)){
args__4742__auto__.push((arguments[i__4737__auto___60329]));

var G__60330 = (i__4737__auto___60329 + (1));
i__4737__auto___60329 = G__60330;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq60283){
...
return (function() { 
var G__60337__delegate = function (rdr,_){
...
var G__60337 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__60339__i = 0, G__60339__a = new Array(arguments.length -  1);
while (G__60339__i < G__60339__a.length) {G__60339__a[G__60339__i] = arguments[G__60339__i + 1]; ++G__60339__i;}
  _ = new cljs.core.IndexedSeq(G__60339__a,0,null);
} 
return G__60337__delegate.call(this,rdr,_);};
G__60337.cljs$lang$maxFixedArity = 1;
G__60337.cljs$lang$applyTo = (function (arglist__60341){
var rdr = cljs.core.first(arglist__60341);
var _ = cljs.core.rest(arglist__60341);
return G__60337__delegate(rdr,_);
});
G__60337.cljs$core$IFn$_invoke$arity$variadic = G__60337__delegate;
return G__60337;
})()
;
});
