...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__65354){
...
var request = map__65355__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65355__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__65360 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__65360.cljs$core$IFn$_invoke$arity$1 ? fexpr__65360.cljs$core$IFn$_invoke$arity$1(response) : fexpr__65360.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__65361 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__65361.cljs$core$IFn$_invoke$arity$1 ? fexpr__65361.cljs$core$IFn$_invoke$arity$1(response) : fexpr__65361.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__65362){
...
var request = map__65363__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65363__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
