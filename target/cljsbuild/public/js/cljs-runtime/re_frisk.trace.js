...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (items,p__61682){
...
var trace = map__61683__$1;
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61683__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61683__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61683__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61683__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var G__61687 = op_type__$1;
var G__61687__$1 = (((G__61687 instanceof cljs.core.Keyword))?G__61687.fqn:null);
switch (G__61687__$1) {
case "event":
...
return (function (p__61707){
var map__61708 = p__61707;
var map__61708__$1 = (((((!((map__61708 == null))))?(((((map__61708.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61708.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__61708):map__61708);
var trace = map__61708__$1;
var subs_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61708__$1,new cljs.core.Keyword(null,"subs?","subs?",-2085240020));
var subs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61708__$1,new cljs.core.Keyword(null,"subs","subs",-186681991));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61708__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var handler_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61708__$1,new cljs.core.Keyword(null,"handler-duration","handler-duration",262132324));
var fx_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61708__$1,new cljs.core.Keyword(null,"fx-duration","fx-duration",1796312432));
var map__61711 = (cljs.core.truth_(subs_QMARK_)?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([trace,cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__61712){
var map__61715 = p__61712;
...
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61715__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
var op_type__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61715__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61715__$1,new cljs.core.Keyword(null,"end","end",-268185958));
var cached_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61715__$1,new cljs.core.Keyword(null,"cached?","cached?",86081880));
var G__61729 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(acc,new cljs.core.Keyword(null,"duration","duration",1444101068),cljs.core._PLUS_,duration);
var G__61729__$1 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61729,new cljs.core.Keyword(null,"end","end",-268185958),end)
;
var G__61729__$2 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword("sub","run","sub/run",-1821315581)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61729__$1,new cljs.core.Keyword(null,"run-count","run-count",-924546145),cljs.core.inc),new cljs.core.Keyword(null,"run-duration","run-duration",1321930251),cljs.core._PLUS_,duration):G__61729__$1);
var G__61729__$3 = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword("sub","create","sub/create",-1301317560))) && (cljs.core.not(cached_QMARK_))))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61729__$2,new cljs.core.Keyword(null,"created-count","created-count",-1708534686),cljs.core.inc),new cljs.core.Keyword(null,"created-duration","created-duration",-1526658187),cljs.core._PLUS_,duration):G__61729__$2);
var G__61729__$4 = (cljs.core.truth_(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword("sub","create","sub/create",-1301317560)))?cached_QMARK_:false))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61729__$3,new cljs.core.Keyword(null,"created-count-cached","created-count-cached",1601348000),cljs.core.inc),new cljs.core.Keyword(null,"created-duration-cached","created-duration-cached",1269460585),cljs.core._PLUS_,duration):G__61729__$3);
var G__61729__$5 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword("sub","dispose","sub/dispose",365440536)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61729__$4,new cljs.core.Keyword(null,"disposed-count","disposed-count",-457935431),cljs.core.inc),new cljs.core.Keyword(null,"disposed-duration","disposed-duration",-1737482274),cljs.core._PLUS_,duration):G__61729__$4);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword(null,"render","render",-1408033454))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__61729__$5,new cljs.core.Keyword(null,"render-count","render-count",-875399191),cljs.core.inc),new cljs.core.Keyword(null,"render-duration","render-duration",1704092121),cljs.core._PLUS_,duration);
} else {
return G__61729__$5;
}
...
var trace__$1 = map__61711__$1;
var render_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"render-duration","render-duration",1704092121));
var disposed_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"disposed-duration","disposed-duration",-1737482274));
var handler_duration__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"handler-duration","handler-duration",262132324));
var created_duration_cached = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"created-duration-cached","created-duration-cached",1269460585));
var run_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"run-duration","run-duration",1321930251));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
var fx_duration__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"fx-duration","fx-duration",1796312432));
var created_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61711__$1,new cljs.core.Keyword(null,"created-duration","created-duration",-1526658187));
var G__61774 = trace__$1;
var G__61774__$1 = (cljs.core.truth_(duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61774,new cljs.core.Keyword(null,"duration-ms","duration-ms",1993555055),re_frisk.utils.str_ms(duration)):G__61774);
var G__61774__$2 = (cljs.core.truth_(handler_duration__$1)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61774__$1,new cljs.core.Keyword(null,"handler-duration-ms","handler-duration-ms",-491924416),re_frisk.utils.str_ms(handler_duration__$1)):G__61774__$1);
var G__61774__$3 = (cljs.core.truth_(fx_duration__$1)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61774__$2,new cljs.core.Keyword(null,"fx-duration-ms","fx-duration-ms",-1014211328),re_frisk.utils.str_ms(fx_duration__$1)):G__61774__$2);
var G__61774__$4 = (cljs.core.truth_(run_duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61774__$3,new cljs.core.Keyword(null,"run-duration-ms","run-duration-ms",-1510786585),re_frisk.utils.str_ms(run_duration)):G__61774__$3);
var G__61774__$5 = (cljs.core.truth_(created_duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61774__$4,new cljs.core.Keyword(null,"created-duration-ms","created-duration-ms",1987553257),re_frisk.utils.str_ms(created_duration)):G__61774__$4);
var G__61774__$6 = (cljs.core.truth_(created_duration_cached)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61774__$5,new cljs.core.Keyword(null,"created-duration-cached-ms","created-duration-cached-ms",1699705669),re_frisk.utils.str_ms(created_duration_cached)):G__61774__$5);
var G__61774__$7 = (cljs.core.truth_(disposed_duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61774__$6,new cljs.core.Keyword(null,"disposed-duration-ms","disposed-duration-ms",-1456969189),re_frisk.utils.str_ms(disposed_duration)):G__61774__$6);
var G__61774__$8 = (cljs.core.truth_(render_duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61774__$7,new cljs.core.Keyword(null,"render-duration-ms","render-duration-ms",-757772115),re_frisk.utils.str_ms(render_duration)):G__61774__$7);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61774__$8,new cljs.core.Keyword(null,"position","position",-2011731912),(start - new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(first_event)));
