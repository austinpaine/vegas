...
var _STAR_print_newline_STAR__orig_val__53382_53460 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53383_53461 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53384_53462 = true;
var _STAR_print_fn_STAR__temp_val__53385_53463 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53384_53462);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53385_53463);

try{var _STAR_print_level_STAR__orig_val__53386_53464 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__53387_53465 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__53387_53465);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__53386_53464);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53383_53461);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53382_53460);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq53381){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq53381));
}));
...
var new_formatters = current_formatters.filter((function (p1__53410_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__53410_SHARP_)));
}));
...
var G__53419_53485 = f;
var target__51482__auto___53486 = G__53419_53485;
if(cljs.core.truth_(target__51482__auto___53486)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53419_53485)].join(''),"\n","target__51482__auto__"].join('')));
}

(target__51482__auto___53486["toString"] = (function (){
...
var G__53421_53487 = "%c%s";
var G__53422_53488 = "color:transparent";
var G__53423_53489 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__53421_53487,G__53422_53488,G__53423_53489) : f.call(null,G__53421_53487,G__53422_53488,G__53423_53489));
...
var args__4742__auto__ = [];
var len__4736__auto___53494 = arguments.length;
var i__4737__auto___53495 = (0);
while(true){
if((i__4737__auto___53495 < len__4736__auto___53494)){
args__4742__auto__.push((arguments[i__4737__auto___53495]));

var G__53496 = (i__4737__auto___53495 + (1));
i__4737__auto___53495 = G__53496;
continue;
} else {
}
break;
...
var vec__53434 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53434,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53434,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__53502__delegate = function (add_fmt,add_args){
...
var G__53502 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__53504__i = 0, G__53504__a = new Array(arguments.length -  1);
while (G__53504__i < G__53504__a.length) {G__53504__a[G__53504__i] = arguments[G__53504__i + 1]; ++G__53504__i;}
  add_args = new cljs.core.IndexedSeq(G__53504__a,0,null);
} 
return G__53502__delegate.call(this,add_fmt,add_args);};
G__53502.cljs$lang$maxFixedArity = 1;
G__53502.cljs$lang$applyTo = (function (arglist__53505){
var add_fmt = cljs.core.first(arglist__53505);
var add_args = cljs.core.rest(arglist__53505);
return G__53502__delegate(add_fmt,add_args);
});
G__53502.cljs$core$IFn$_invoke$arity$variadic = G__53502__delegate;
return G__53502;
})()
);
}));
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq53428){
var G__53429 = cljs.core.first(seq53428);
var seq53428__$1 = cljs.core.next(seq53428);
var G__53430 = cljs.core.first(seq53428__$1);
var seq53428__$2 = cljs.core.next(seq53428__$1);
var G__53431 = cljs.core.first(seq53428__$2);
var seq53428__$3 = cljs.core.next(seq53428__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53429,G__53430,G__53431,seq53428__$3);
}));
...
var seq__53442 = cljs.core.seq(features);
var chunk__53443 = null;
var count__53444 = (0);
var i__53445 = (0);
while(true){
if((i__53445 < count__53444)){
var feature = chunk__53443.cljs$core$IIndexed$_nth$arity$2(null,i__53445);
...
var G__53508 = seq__53442;
var G__53509 = chunk__53443;
var G__53510 = count__53444;
var G__53511 = (i__53445 + (1));
seq__53442 = G__53508;
chunk__53443 = G__53509;
count__53444 = G__53510;
i__53445 = G__53511;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__53442);
if(temp__5735__auto__){
var seq__53442__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__53442__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__53442__$1);
var G__53512 = cljs.core.chunk_rest(seq__53442__$1);
var G__53513 = c__4556__auto__;
var G__53514 = cljs.core.count(c__4556__auto__);
var G__53515 = (0);
seq__53442 = G__53512;
chunk__53443 = G__53513;
count__53444 = G__53514;
i__53445 = G__53515;
continue;
} else {
var feature = cljs.core.first(seq__53442__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__53516 = cljs.core.next(seq__53442__$1);
var G__53517 = null;
var G__53518 = (0);
var G__53519 = (0);
seq__53442 = G__53516;
chunk__53443 = G__53517;
count__53444 = G__53518;
i__53445 = G__53519;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o53454 = temp__5733__auto__;
return (o53454["version"]);
} else {
return null;
}
})() == null);
