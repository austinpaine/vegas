...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_64735 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_64735(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_64739 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_64739(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_64750 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_64750(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_64752 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_64752(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_64756 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_64756(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_64759 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_64759(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_64766 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_64766(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_64771 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_64771(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_64772 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_64772(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_64773 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_64773(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k64664,else__4383__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__64678){
var vec__64679 = p__64678;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64679,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64679,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__64663){
var self__ = this;
var G__64663__$1 = this;
return (new cljs.core.RecordIter((0),G__64663__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this64666,other64667){
var self__ = this;
var this64666__$1 = this;
return (((!((other64667 == null)))) && ((this64666__$1.constructor === other64667.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64666__$1.status,other64667.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64666__$1.body,other64667.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64666__$1.status_text,other64667.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64666__$1.headers,other64667.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64666__$1.was_aborted,other64667.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64666__$1.__extmap,other64667.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__64663){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__64720 = cljs.core.keyword_identical_QMARK_;
var expr__64721 = k__4388__auto__;
if(cljs.core.truth_((pred__64720.cljs$core$IFn$_invoke$arity$2 ? pred__64720.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__64721) : pred__64720.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__64721)))){
return (new ajax.protocols.Response(G__64663,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64720.cljs$core$IFn$_invoke$arity$2 ? pred__64720.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__64721) : pred__64720.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__64721)))){
return (new ajax.protocols.Response(self__.status,G__64663,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64720.cljs$core$IFn$_invoke$arity$2 ? pred__64720.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__64721) : pred__64720.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__64721)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__64663,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64720.cljs$core$IFn$_invoke$arity$2 ? pred__64720.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__64721) : pred__64720.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__64721)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__64663,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64720.cljs$core$IFn$_invoke$arity$2 ? pred__64720.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__64721) : pred__64720.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__64721)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__64663,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__64663),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__64663){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__64663,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__64670){
var extmap__4419__auto__ = (function (){var G__64730 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__64670,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__64670)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__64730);
} else {
return G__64730;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__64670),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__64670),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__64670),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__64670),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__64670),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
