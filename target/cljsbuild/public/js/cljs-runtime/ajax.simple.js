...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__65381){
var map__65383 = p__65381;
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65383__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,new cljs.core.Keyword(null,"method","method",55703592),ajax.simple.normalize_method),new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),(function (p1__65387_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4126__auto__ = p1__65387_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__65392){
var map__65393 = p__65392;
var map__65393__$1 = (((((!((map__65393 == null))))?(((((map__65393.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65393.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65393):map__65393);
var request = map__65393__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65393__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
