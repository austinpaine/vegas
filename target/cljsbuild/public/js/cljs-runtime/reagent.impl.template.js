...
var G__55204 = o;
goog.object.set(G__55204,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__55234__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__55234 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__55235__i = 0, G__55235__a = new Array(arguments.length -  0);
while (G__55235__i < G__55235__a.length) {G__55235__a[G__55235__i] = arguments[G__55235__i + 0]; ++G__55235__i;}
  args = new cljs.core.IndexedSeq(G__55235__a,0,null);
} 
return G__55234__delegate.call(this,args);};
G__55234.cljs$lang$maxFixedArity = 0;
G__55234.cljs$lang$applyTo = (function (arglist__55236){
var args = cljs.core.seq(arglist__55236);
return G__55234__delegate(args);
});
G__55234.cljs$core$IFn$_invoke$arity$variadic = G__55234__delegate;
return G__55234;
})()
;
} else {
...
var G__55206 = o;
goog.object.set(G__55206,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__55248__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__55249__i < G__55249__a.length) {G__55249__a[G__55249__i] = arguments[G__55249__i + 0]; ++G__55249__i;}
  args = new cljs.core.IndexedSeq(G__55249__a,0,null);
} 
return G__55248__delegate.call(this,args);};
G__55248.cljs$lang$maxFixedArity = 0;
G__55248.cljs$lang$applyTo = (function (arglist__55250){
var args = cljs.core.seq(arglist__55250);
return G__55248__delegate(args);
});
...
var G__55209 = props;
var G__55209__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55209,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__55209);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55209__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__55209__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__55210 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55210,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__55210;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__55211){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55212__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__55214_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__55214_SHARP_);
}));
} else {
return null;
}
...
var vec__55216 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55216,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55216,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55216,(2),null);
...
var temp__5739__auto___55290 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___55290 == null)){
} else {
var key_55291 = temp__5739__auto___55290;
(jsprops.key = key_55291);
}
...
var temp__5739__auto___55292 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___55292 == null)){
} else {
var key_55293 = temp__5739__auto___55292;
(jsprops.key = key_55293);
}
...
var G__55220 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__55220) : reagent.impl.template.as_element.call(null,G__55220));
} else {
var temp__5739__auto___55295 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___55295 == null)){
} else {
var key_55296 = temp__5739__auto___55295;
(jsprops.key = key_55296);
}
...
var G__55222 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__55222)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__55222)){
return x;
} else {
...
var len__4736__auto___55301 = arguments.length;
var i__4737__auto___55302 = (0);
while(true){
if((i__4737__auto___55302 < len__4736__auto___55301)){
args__4742__auto__.push((arguments[i__4737__auto___55302]));

var G__55303 = (i__4737__auto___55302 + (1));
i__4737__auto___55302 = G__55303;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq55223){
var G__55224 = cljs.core.first(seq55223);
var seq55223__$1 = cljs.core.next(seq55223);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55224,seq55223__$1);
}));
...
break;
default:
var G__55305 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__55305;
continue;
...
var ctx = ({});
var vec__55227 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55227,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55227,(1),null);
...
var G__55230 = (cljs.core.count(argv) - first_child);
switch (G__55230) {
case (0):
