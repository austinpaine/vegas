...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__59510_SHARP_,p2__59511_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59510_SHARP_,p2__59511_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function re_com$tour$initialise_tour_$_iter__59517(s__59518){
return (new cljs.core.LazySeq(null,(function (){
var s__59518__$1 = s__59518;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__59518__$1);
if(temp__5735__auto__){
var s__59518__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__59518__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__59518__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__59520 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__59519 = (0);
while(true){
if((i__59519 < size__4528__auto__)){
var step = cljs.core._nth(c__4527__auto__,i__59519);
cljs.core.chunk_append(b__59520,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__59555 = (i__59519 + (1));
i__59519 = G__59555;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__59520),re_com$tour$initialise_tour_$_iter__59517(cljs.core.chunk_rest(s__59518__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__59520),null);
}
} else {
var step = cljs.core.first(s__59518__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__59517(cljs.core.rest(s__59518__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__59529 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__59529.cljs$core$IFn$_invoke$arity$1 ? fexpr__59529.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__59529.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__59536 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__59536.cljs$core$IFn$_invoke$arity$1 ? fexpr__59536.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__59536.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__59538 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__59538.cljs$core$IFn$_invoke$arity$1 ? fexpr__59538.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__59538.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__59545 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__59545.cljs$core$IFn$_invoke$arity$1 ? fexpr__59545.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__59545.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__59546 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__59546.cljs$core$IFn$_invoke$arity$1 ? fexpr__59546.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__59546.call(null,tour));
})(),true);
} else {
return null;
}
