...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_59970 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_59970(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_59973 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_59973(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_59976 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_59976(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_59983 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_59983(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_59985 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_59985(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_59986 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_59986(reader);
}
});
...
var G__60065 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__60066 = s.append(c);
c = G__60065;
s = G__60066;
continue;
}
