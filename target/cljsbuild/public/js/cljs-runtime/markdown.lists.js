...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function markdown$lists$close_lists_$_iter__65542(s__65543){
return (new cljs.core.LazySeq(null,(function (){
var s__65543__$1 = s__65543;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__65543__$1);
if(temp__5735__auto__){
var s__65543__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__65543__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__65543__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__65545 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__65544 = (0);
while(true){
if((i__65544 < size__4528__auto__)){
var vec__65546 = cljs.core._nth(c__4527__auto__,i__65544);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65546,(0),null);
cljs.core.chunk_append(b__65545,["</li></",cljs.core.name(list_type),">"].join(''));

var G__65675 = (i__65544 + (1));
i__65544 = G__65675;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65545),markdown$lists$close_lists_$_iter__65542(cljs.core.chunk_rest(s__65543__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65545),null);
}
} else {
var vec__65555 = cljs.core.first(s__65543__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65555,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__65542(cljs.core.rest(s__65543__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__65562_SHARP_){
return (cljs.core.second(p1__65562_SHARP_) > num_indents);
...
var vec__65579 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65579,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65579,(1),null);
...
var vec__65603 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65603,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65603,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__65631){
var map__65632 = p__65631;
...
var state = map__65632__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65632__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65632__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65632__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65632__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
